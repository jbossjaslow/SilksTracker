...
struct MoveNames {
    ...
    static var allMoves = [
        ...
        Sail, 
        ShoulderLockOff, 
        ShoulderStandLegRollUp2Rolls, 
        SidewaysMiddleSplitsV1, 
        SidewaysMiddleSplitsV2, 
        SidewaysMiddleSplitsV3, 
        SingleFootLockAir, 
        SittingHipLean, 
        Splits, 
        StandardDescent, 
        ...
        ball_cartWheels, 
        ball_fang, 
        ball_skinTheCatEntry, 
        ball_skinTheCatExit, 
        ball_splits, 
        ball_stagLegs, 
        basicLegRollUpVariations_gazelle, 
        basicLegRollUpVariations_gazelle_invertedSplitsOpen, 
        basicLegRollUpVariations_gazelle_invertedSplitsRevolved, 
        basicLegRollUpVariations_kidneyHang, 
        basicLegRollUpVariations_kidneyHang_flamencoGripEntrance, 
        basicLegRollUpVariations_kidneyHang_upAndOverFromManOnTheMoonEntrance, 
        basicLegRollUpVariations_splits, 
        basicLegRollUpVariations_splits_open, 
        basicLegRollUpVariations_splits_revolved, 
        cocoonVariations_fanOnBackFabric, 
        cocoonVariations_fanOnFrontFabric, 
        crossbackStraddleVariations_butterflyExit, 
        crossbackStraddleVariations_splitsRollUpToXEntry, 
        crossbackStraddleVariations_transitionToSideMiddleSplitsV3, 
        ironT, 
        laybackInvertVariations_laybackInvertSplits, 
        laybackInvertVariations_pike, 
        laybackInvertVariations_skinTheLaybackInvert, 
        roundTheBackHold_sailDance, 
        shoulderSlingFromSupportedBridge, 
        sittingHipLeanVariations_noHands, 
        sittingHipLeanVariations_oppositeSideLean, 
        sittingHipLeanVariations_singleFootLock, 
        standingHipLeanVariations_heartToCeilingNoHands, 
        standingHipLeanVariations_noHands, 
        standingHipLeanVariations_singleFootLock, 
        standingVariationsOnBasicFootlock_backSail, 
        standingVariationsOnBasicFootlock_frontSail, 
